...
# input_mem_data = np.array([(i * 4.0 /1024/ 1024 ) for i in out_sizes])  # KB
...
# axis.set_title('Memory size distribution of input data(MB)'
            #    , fontsize=title_size)
# axis.set_title('Memory size distribution of output data(MB)'
#                , fontsize=title_size)
axis.set_title('Ratio distribution of input to output size'
               , fontsize=title_size)
...
plt.savefig('max_pool2d_para.png', dpi=600)